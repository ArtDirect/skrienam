/* Skrienam: one table, five functions.
   Paste this whole file into Supabase -> SQL Editor -> Run.
   Safe to run again: nothing here destroys existing data.

   Block comments on purpose. A "--" comment breaks the whole script if a
   single hyphen is lost in copy-paste, and web editors do lose one. */
...
/* Join: append the name, never twice. Atomic at the row, so two people
   tapping at the same moment both land. */
...
/* Rename: carry authorship with you when you change your display name.
   Without this your own runs stay stamped with the old name and you lose
